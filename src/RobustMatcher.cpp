...
void RobustMatcher::robustMatch(const cv::Mat& frame, const cv::Mat& keyframe,
    std::vector<cv::KeyPoint>& keypoints_frame, const cv::Mat& descriptors_frame, 
    ...
    std::vector<cv::DMatch>& good_matches)
{
    ...
    {
        cv::drawMatches(frame, keypoints_frame, keyframe, keypoints_model, good_matches, img_matching_);
    }
}
